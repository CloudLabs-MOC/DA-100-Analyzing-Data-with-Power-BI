...
# **DA-100 Module 6: Create a Power BI Dashboard**
...
8. In the **Open** window, navigate to the **C:\AllFiles\DA-100-Analyzing-Data-with-Power-BI-prod-rcc\Allfiles\DA-100-Allfiles\Labs\09-create-power-bi-dashboard\Starter** folder.
...
6. In the **Pin to Dashboard** window, select new dahboard, in the **Dashboard Name** box, enter **Sales Monitoring**.
...
24. In the **Add Image Tile** pane, in the **URL** box, enter the complete URL found in the **C:\AllFiles\DA-100-Analyzing-Data-with-Power-BI-prod-rcc\Allfiles\DA-100-Allfiles\Resources\AdventureWorksLogo_DataURL.txt** file.
...
1. In File Explorer, inside the **C:\AllFiles\DA-100-Analyzing-Data-with-Power-BI-prod-rcc\Allfiles\DA-100-Allfiles\Setup** folder, right-click the **UpdateDatabase-2-AddSales.ps1** file, and then select **Run with PowerShell**.
